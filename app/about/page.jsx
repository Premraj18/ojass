...
const page = () => {
  return (
    <>
      <div className="w-full min-h-[100vh] sm:mt-0 lg:pt-14 pt-20 bg-[url('/img11.jpeg')] bg-center bg-cover bg-no-repeat bg-fixed">
        ...
        >
          <div className='pt-44 w-full flex justify-center items-center'>
            <img src="/abouttext2.png" alt="" className='w-[80%] lg:w-1/3' />
          </div>
