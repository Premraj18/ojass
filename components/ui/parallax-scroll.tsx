...
export const ParallaxScroll = ({
  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col md:flex-row px-8 md:justify-evenly justify-center items-center -mt-28 mb-5'>
      ...
      <div className='flex flex-col md:flex-row px-8 md:justify-evenly justify-center items-center  mt-10 mb-5'>
